                    ...
                    <Table>
                        ...
                        <Table.Tbody>
                            {locations.data.map((location, i) => (
                                <tr key={i}>
                                    <Table.Td>{++i + (locations.current_page - 1) * locations.per_page}</Table.Td>
                                            ...
                                            <div className="flex flex-col gap-2">
                                                {location.image_urls.map((img, idx) => (
                                                    <img
                                                        ...
                                                        src={img}
                                                        alt={`Image ${idx + 1}`}
                                                        className="object-cover w-16 h-16 transition rounded-md cursor-pointer hover:opacity-75"
                                    ...
                                    <Table.Td>{location.category ? location.category.name : "N/A"}</Table.Td>
                                    <Table.Td>{location.ticket ? location.ticket.ticket_code : "N/A"}</Table.Td>
                                    <Table.Td>
                ...
                >
                    <div className="relative max-w-4xl mx-auto">
                        ...
                        <button
                            ...
                            className="absolute p-2 text-white bg-red-600 rounded-full shadow-lg top-2 right-2"
                        >
                            ✕
                        </button>
                    </div>
