...
const Card = ({ title, className, children }) => {
    return (
        <>
            ...
            <div className="bg-white border-t-0 rounded-b-lg">{children}</div>
        </>
    );
};
...
const Table = ({ children }) => {
    return (
        <>
            <div className="w-full overflow-hidden overflow-x-auto border border-t-0 border-collapse rounded-b-lg">
...
const Td = ({ className, children }) => {
    return (
        <td className={`${className} whitespace-nowrap p-4 align-middle text-gray-700`}>
            {children}
        </td>
    );
};
...
const Th = ({ className, children }) => {
    return (
        <th scope="col" className={`${className} h-12 px-4 text-left align-middle font-medium text-gray-700`}>
            {children}
        </th>
    );
};
